...
HXLINE(  56)		this->animation->addByPrefix(HX_("kei",8f,89,51,00),HX_("bllck",8a,2e,fa,b4),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("kei",8f,89,51,00), ::CharacterSetting_obj::__alloc( HX_CTX ,-30,140,((Float)0.77),null()));
HXDLIN(  24)			return _g;
            		}

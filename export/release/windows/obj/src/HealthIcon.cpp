...
HXLINE(  35)		this->animation->add(HX_("gfnerves",48,b8,47,03),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_18,1),0,false,isPlayer,null());
...
HXLINE(  41)		this->animation->add(HX_("kei",8f,89,51,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_24,2),0,false,isPlayer,null());
HXLINE(  42)		this->animation->add(HX_("keihappy",31,d5,a5,6d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_25,2),0,false,isPlayer,null());

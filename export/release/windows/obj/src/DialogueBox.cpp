...
HX_LOCAL_STACK_FRAME(_hx_pos_abff9fa8c13cc7a0_284_cleanDialog,"DialogueBox","cleanDialog",0x0fc249f6,"DialogueBox.cleanDialog","DialogueBox.hx",284,0x0149b4eb)
...
HXLINE( 150)		this->dialogueStarted = false;
HXLINE( 149)		this->dialogueOpened = false;
...
HXLINE(  67)		this->portraitLeft =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,120,-4,null());
HXLINE(  68)		 ::flixel::FlxSprite _hx_tmp2 = this->portraitLeft;
HXDLIN(  68)		::String library = null();
HXDLIN(  68)		::String _hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keithink",7a,99,28,fb)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  68)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp3,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keithink",7a,99,28,fb)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE(  69)		this->portraitLeft->animation->addByPrefix(HX_("enter",18,6d,86,70),HX_("keithink",03,f8,0f,5b),24,false,null(),null());
HXLINE(  70)		this->portraitLeft->scrollFactor->set(null(),null());
HXLINE(  71)		this->portraitLeft->set_visible(true);
HXLINE(  73)		this->portraitRight =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,700,57,null());
HXLINE(  74)		 ::flixel::FlxSprite _hx_tmp4 = this->portraitRight;
HXDLIN(  74)		::String library1 = null();
HXDLIN(  74)		::String _hx_tmp5 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/bftalk",a7,c6,f1,24)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN(  74)		_hx_tmp4->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp5,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/bftalk",a7,c6,f1,24)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE(  75)		this->portraitRight->animation->addByPrefix(HX_("enter",18,6d,86,70),HX_("Boyfriend portrait enter instance 1",fd,0e,28,82),24,false,null(),null());
HXLINE(  76)		this->portraitRight->scrollFactor->set(null(),null());
HXLINE(  77)		this->portraitRight->set_visible(false);
...
HXLINE(  93)			goto _hx_goto_1;
            		...
            		/* default */{
HXLINE( 103)			hasDialog = true;
HXLINE( 104)			::PlayState_obj::daPixelZoom = ( (Float)(1) );
HXLINE( 105)			 ::flixel::FlxSprite _hx_tmp = this->box;
HXDLIN( 105)			::String library = null();
HXDLIN( 105)			_hx_tmp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/dia",25,0f,c5,ec)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),true,1280,720,null(),null());
HXLINE( 106)			this->box->animation->add(HX_("normalOpen",91,41,38,70),::Array_obj< int >::fromData( _hx_array_data_ffc81fb3_7,1),0,null(),null(),null());
HXLINE( 107)			this->box->animation->add(HX_("normal",27,72,69,30),::Array_obj< int >::fromData( _hx_array_data_ffc81fb3_8,1),0,null(),null(),null());
HXLINE( 108)			this->box->setPosition(null(),null());
            		}
            		_hx_goto_1:;
...
HXLINE( 114)		this->box->animation->play(HX_("normalOpen",91,41,38,70),null(),null(),null());
HXLINE( 117)		this->add(this->box);
HXLINE( 122)		 ::flixel::FlxSprite _hx_tmp6 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.9)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.9)),null());
HXDLIN( 122)		this->handSelect = _hx_tmp6->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/hand_textbox",67,1b,cd,60)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week6",c2,95,be,c7)),null(),null(),null(),null(),null());
HXLINE( 123)		this->add(this->handSelect);
HXLINE( 126)		bool _hx_tmp7 = !(talkingRight);
HXLINE( 131)		this->dropText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,342,502,::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.6))),HX_(".",2e,00,00,00),32,null());
HXLINE( 133)		this->dropText->set_color(800080);
HXLINE( 134)		this->add(this->dropText);
HXLINE( 136)		this->swagDialogue =  ::flixel::addons::text::FlxTypeText_obj::__alloc( HX_CTX ,( (Float)(340) ),( (Float)(500) ),::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.6))),HX_(".",2e,00,00,00),32,null());
HXLINE( 138)		this->swagDialogue->set_color(-1);
HXLINE( 139)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp8 = ::flixel::FlxG_obj::sound;
HXDLIN( 139)		 ::flixel::_hx_system::FlxSound _hx_tmp9 = _hx_tmp8->load(::Paths_obj::sound(HX_("pixelText",53,7a,83,06),null()),((Float)0.6),null(),null(),null(),null(),null(),null(),null());
HXDLIN( 139)		this->swagDialogue->sounds = ::Array_obj< ::Dynamic>::__new(1)->init(0,_hx_tmp9);
HXLINE( 140)		this->add(this->swagDialogue);
HXLINE( 142)		this->add(this->portraitLeft);
HXLINE( 143)		this->add(this->portraitRight);
HXLINE( 144)		this->dialogue =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(80) ),HX_("",00,00,00,00),false,true,null());
            	}
...
HXLINE( 159)			this->portraitLeft->set_color(-16777216);
...
HXDLIN( 181)		if (( ( ::flixel::input::FlxBaseKeyList)(::flixel::FlxG_obj::keys->justPressed) )->get_ANY()) {
HXLINE( 181)			_hx_tmp1 = (this->dialogueStarted == true);
            		}
            		else {
HXLINE( 181)			_hx_tmp1 = false;
            		}
HXDLIN( 181)		if (_hx_tmp1) {
HXLINE( 183)			this->remove(this->dialogue,null());
HXLINE( 185)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 185)			_hx_tmp->play(::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
HXLINE( 187)			bool _hx_tmp1;
HXDLIN( 187)			if (::hx::IsNull( this->dialogueList->__get(1) )) {
HXLINE( 187)				_hx_tmp1 = ::hx::IsNotNull( this->dialogueList->__get(0) );
            			}
            			else {
HXLINE( 187)				_hx_tmp1 = false;
            			}
HXDLIN( 187)			if (_hx_tmp1) {
HXLINE( 189)				if (!(this->isEnding)) {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::DialogueBox,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::util::FlxTimer tmr){
...
HXLINE( 200)						_gthis->portraitLeft->set_visible(false);
HXLINE( 201)						_gthis->portraitRight->set_visible(false);
HXLINE( 202)						{
HXLINE( 202)							 ::flixel::addons::text::FlxTypeText _g2 = _gthis->swagDialogue;
HXDLIN( 202)							_g2->set_alpha((_g2->alpha - ((Float)0.2)));
            						}
...
HXLINE( 191)					this->isEnding = true;
HXLINE( 193)					bool _hx_tmp;
HXDLIN( 193)					if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() != HX_("senpai",3c,df,8d,6b))) {
HXLINE( 193)						_hx_tmp = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c));
            					}
            					else {
...
HXDLIN( 194)						_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(_this->_volume,( (Float)(To) ),((Float)2.2), ::Dynamic(::hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            					}
...
HXLINE( 272)			goto _hx_goto_12;
            		}
            		if (  (_hx_switch_0==HX_("dad",47,36,4c,00)) ){
HXLINE( 239)			this->portraitRight->set_visible(false);
HXLINE( 240)			 ::flixel::FlxSprite _hx_tmp = this->portraitLeft;
HXDLIN( 240)			::String library = null();
HXDLIN( 240)			::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keithink",7a,99,28,fb)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 240)			_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keithink",7a,99,28,fb)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 241)			if (!(this->portraitLeft->visible)) {
HXLINE( 243)				this->portraitLeft->set_visible(true);
HXLINE( 244)				this->portraitLeft->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 238)			goto _hx_goto_12;
            		}
            		if (  (_hx_switch_0==HX_("happy",20,65,1f,22)) ){
HXLINE( 255)			this->portraitRight->set_visible(false);
HXLINE( 256)			 ::flixel::FlxSprite _hx_tmp = this->portraitLeft;
HXDLIN( 256)			::String library = null();
HXDLIN( 256)			::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keiaccept",80,d8,96,4a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 256)			_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keiaccept",80,d8,96,4a)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
...
HXLINE( 254)			goto _hx_goto_12;
            		...
            		if (  (_hx_switch_0==HX_("idk",30,04,50,00)) ){
HXLINE( 264)			this->portraitRight->set_visible(false);
HXLINE( 265)			 ::flixel::FlxSprite _hx_tmp = this->portraitLeft;
HXDLIN( 265)			::String library = null();
HXDLIN( 265)			::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keitry",c3,88,8a,23)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 265)			_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keitry",c3,88,8a,23)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 266)			if (!(this->portraitLeft->visible)) {
HXLINE( 268)				this->portraitLeft->set_visible(true);
HXLINE( 269)				this->portraitLeft->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 263)			goto _hx_goto_12;
            		}
            		if (  (_hx_switch_0==HX_("sad",16,98,57,00)) ){
HXLINE( 247)			this->portraitRight->set_visible(false);
HXLINE( 248)			 ::flixel::FlxSprite _hx_tmp = this->portraitLeft;
HXDLIN( 248)			::String library = null();
HXDLIN( 248)			::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keidissaster",32,4c,e1,70)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 248)			_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("portraits/keidissaster",32,4c,e1,70)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 249)			if (!(this->portraitLeft->visible)) {
HXLINE( 251)				this->portraitLeft->set_visible(true);
HXLINE( 252)				this->portraitLeft->animation->play(HX_("enter",18,6d,86,70),null(),null(),null());
            			}
HXLINE( 246)			goto _hx_goto_12;
            		}
            		_hx_goto_12:;
            	}
...
void DialogueBox_obj::cleanDialog(){
            	HX_STACKFRAME(&_hx_pos_abff9fa8c13cc7a0_284_cleanDialog)
HXLINE( 285)		::Array< ::String > splitName = this->dialogueList->__get(0).split(HX_(":",3a,00,00,00));
HXLINE( 286)		this->curCharacter = splitName->__get(1);
HXLINE( 287)		this->dialogueList[0] = ::StringTools_obj::trim(this->dialogueList->__get(0).substr((splitName->__get(1).length + 2),null()));
            	}

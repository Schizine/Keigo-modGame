...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_277_checkByName,"Controls","checkByName",0xbe587cd2,"Controls.checkByName","Controls.hx",277,0x0ab041e8)
...
bool Controls_obj::checkByName(::String name){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_277_checkByName)
HXLINE( 279)		if (!(this->byName->exists(name))) {
HXLINE( 280)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Invalid name: ",da,fb,f0,ea) + name)));
            		}
HXLINE( 282)		return ( ( ::flixel::input::actions::FlxActionDigital)(this->byName->get(name)) )->check();
            	}

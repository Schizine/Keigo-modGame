...
HXLINE(  67)		this->portraitLeft =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,120,-3,null());
...
HXLINE(  73)		this->portraitRight =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,700,59,null());
...
HXLINE( 133)		this->dropText->set_color(807396);

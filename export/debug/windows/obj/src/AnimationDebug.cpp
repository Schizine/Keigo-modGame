...
HXLINE(  89)		{
HXLINE(  89)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,this->_hx_char->animOffsets);
HXDLIN(  89)			while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  89)				 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN(  89)				::String anim = ( (::String)(_g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic)) );
HXDLIN(  89)				::cpp::VirtualArray offsets = ( (::cpp::VirtualArray)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE(  90)				{
...
HXLINE( 103)		 ::AnimationDebug _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 117)			 ::flixel::FlxCamera _g = ::flixel::FlxG_obj::camera;
HXDLIN( 117)			_g->set_zoom((_g->zoom + ((Float)0.25)));
            		}
...
HXLINE( 119)			 ::flixel::FlxCamera _g = ::flixel::FlxG_obj::camera;
HXDLIN( 119)			_g->set_zoom((_g->zoom - ((Float)0.25)));
            		}
...
HXDLIN( 158)		if (!(_this5->keyManager->checkStatus(83,_this5->status))) {
HXLINE( 158)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 158)			_hx_tmp4 = _this->keyManager->checkStatus(87,_this->status);
            		}
            		else {
...
HXLINE( 158)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 158)			_hx_tmp3 = _this->keyManager->checkStatus(32,_this->status);
            		}
            		else {
...
HXDLIN( 171)		bool holdShift = _this6->keyManager->checkStatus(16,_this6->status);
...
HXLINE( 179)			if (upP) {
HXLINE( 180)				::cpp::VirtualArray _hx_tmp = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 180)				int _hx_tmp1 = 1;
HXDLIN( 180)				_hx_tmp->set(_hx_tmp1,(_hx_tmp->__get(_hx_tmp1) + multiplier));
            			}
HXLINE( 181)			if (downP) {
HXLINE( 182)				::cpp::VirtualArray _hx_tmp = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 182)				int _hx_tmp1 = 1;
HXDLIN( 182)				_hx_tmp->set(_hx_tmp1,(_hx_tmp->__get(_hx_tmp1) - multiplier));
            			}
HXLINE( 183)			if (leftP) {
HXLINE( 184)				::cpp::VirtualArray _hx_tmp = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 184)				int _hx_tmp1 = 0;
HXDLIN( 184)				_hx_tmp->set(_hx_tmp1,(_hx_tmp->__get(_hx_tmp1) + multiplier));
            			}

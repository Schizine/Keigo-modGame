...
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_319_updateDebugTileBoundingBoxSolid,"flixel.tile.FlxTilemap","updateDebugTileBoundingBoxSolid",0xf2502658,"flixel.tile.FlxTilemap.updateDebugTileBoundingBoxSolid","flixel/tile/FlxTilemap.hx",319,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_324_updateDebugTileBoundingBoxNotSolid,"flixel.tile.FlxTilemap","updateDebugTileBoundingBoxNotSolid",0x299bee0b,"flixel.tile.FlxTilemap.updateDebugTileBoundingBoxNotSolid","flixel/tile/FlxTilemap.hx",324,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_329_updateDebugTileBoundingBoxPartial,"flixel.tile.FlxTilemap","updateDebugTileBoundingBoxPartial",0xa959eeee,"flixel.tile.FlxTilemap.updateDebugTileBoundingBoxPartial","flixel/tile/FlxTilemap.hx",329,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_333_updateDebugTile,"flixel.tile.FlxTilemap","updateDebugTile",0x0398ec94,"flixel.tile.FlxTilemap.updateDebugTile","flixel/tile/FlxTilemap.hx",333,0x448feb74)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_380_drawDebugOnCamera,"flixel.tile.FlxTilemap","drawDebugOnCamera",0x0d929baf,"flixel.tile.FlxTilemap.drawDebugOnCamera","flixel/tile/FlxTilemap.hx",380,0x448feb74)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1063_makeDebugTile,"flixel.tile.FlxTilemap","makeDebugTile",0xa1ed2d0f,"flixel.tile.FlxTilemap.makeDebugTile","flixel/tile/FlxTilemap.hx",1063,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1074_drawDebugTile,"flixel.tile.FlxTilemap","drawDebugTile",0x086b4839,"flixel.tile.FlxTilemap.drawDebugTile","flixel/tile/FlxTilemap.hx",1074,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1091_onDrawDebugChanged,"flixel.tile.FlxTilemap","onDrawDebugChanged",0x3243d108,"flixel.tile.FlxTilemap.onDrawDebugChanged","flixel/tile/FlxTilemap.hx",1091,0x448feb74)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1250_set_debugBoundingBoxColorSolid,"flixel.tile.FlxTilemap","set_debugBoundingBoxColorSolid",0x6fe5cfdd,"flixel.tile.FlxTilemap.set_debugBoundingBoxColorSolid","flixel/tile/FlxTilemap.hx",1250,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1257_set_debugBoundingBoxColorNotSolid,"flixel.tile.FlxTilemap","set_debugBoundingBoxColorNotSolid",0xa41f45a6,"flixel.tile.FlxTilemap.set_debugBoundingBoxColorNotSolid","flixel/tile/FlxTilemap.hx",1257,0x448feb74)
HX_LOCAL_STACK_FRAME(_hx_pos_1146cbfc6764fb25_1264_set_debugBoundingBoxColorPartial,"flixel.tile.FlxTilemap","set_debugBoundingBoxColorPartial",0xf6d0c3b3,"flixel.tile.FlxTilemap.set_debugBoundingBoxColorPartial","flixel/tile/FlxTilemap.hx",1264,0x448feb74)
namespace flixel{
namespace tile{
...
HXLINE( 184)		this->set_debugBoundingBoxColorSolid(-16744448);
HXLINE( 185)		this->set_debugBoundingBoxColorPartial(-16181);
HXLINE( 186)		this->set_debugBoundingBoxColorNotSolid(0);
HXLINE( 188)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 189)			::flixel::FlxG_obj::debugger->drawDebugChanged->add(this->onDrawDebugChanged_dyn());
            		}
            	}
...
HXLINE( 207)			this->_debugRect = null();
HXLINE( 208)			this->_debugTileNotSolid = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_debugTileNotSolid);
HXLINE( 209)			this->_debugTilePartial = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_debugTilePartial);
HXLINE( 210)			this->_debugTileSolid = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_debugTileSolid);
            		}
            		else {
...
HXLINE( 235)			::flixel::FlxG_obj::debugger->drawDebugChanged->remove(this->onDrawDebugChanged_dyn());
            		}
...
HXLINE( 310)		this->updateDebugTileBoundingBoxSolid();
HXLINE( 311)		this->updateDebugTileBoundingBoxNotSolid();
HXLINE( 312)		this->updateDebugTileBoundingBoxPartial();
            	}


void FlxTilemap_obj::updateDebugTileBoundingBoxSolid(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_319_updateDebugTileBoundingBoxSolid)
HXDLIN( 319)		this->_debugTileSolid = this->updateDebugTile(this->_debugTileSolid,this->debugBoundingBoxColorSolid);
            	}
...
void FlxTilemap_obj::updateDebugTileBoundingBoxNotSolid(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_324_updateDebugTileBoundingBoxNotSolid)
HXDLIN( 324)		this->_debugTileNotSolid = this->updateDebugTile(this->_debugTileNotSolid,this->debugBoundingBoxColorNotSolid);
            	}
...
void FlxTilemap_obj::updateDebugTileBoundingBoxPartial(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_329_updateDebugTileBoundingBoxPartial)
HXDLIN( 329)		this->_debugTilePartial = this->updateDebugTile(this->_debugTilePartial,this->debugBoundingBoxColorPartial);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTilemap_obj,updateDebugTileBoundingBoxPartial,(void))
 ...
 ::openfl::display::BitmapData FlxTilemap_obj::updateDebugTile( ::openfl::display::BitmapData tileBitmap,int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_333_updateDebugTile)
HXLINE( 334)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 335)			return null();
            		}
HXLINE( 337)		bool _hx_tmp;
HXDLIN( 337)		if ((this->_tileWidth > 0)) {
HXLINE( 337)			_hx_tmp = (this->_tileHeight <= 0);
            		}
            		else {
...
HXDLIN( 340)		if (::hx::IsNotNull( tileBitmap )) {
HXLINE( 340)			if ((tileBitmap->width == this->_tileWidth)) {
HXLINE( 340)				_hx_tmp1 = (tileBitmap->height != this->_tileHeight);
            			}
            			else {
...
HXLINE( 341)			tileBitmap = ::flixel::util::FlxDestroyUtil_obj::dispose(tileBitmap);
            		}
HXLINE( 343)		if (::hx::IsNull( tileBitmap )) {
HXLINE( 344)			tileBitmap = this->makeDebugTile(color);
            		}
            		else {
HXLINE( 347)			tileBitmap->fillRect(tileBitmap->rect,0);
HXLINE( 348)			this->drawDebugTile(tileBitmap,color);
            		}
HXLINE( 351)		this->setDirty(null());
HXLINE( 352)		return tileBitmap;
            	}
...
void FlxTilemap_obj::updateMap(){
            	HX_GC_STACKFRAME(&_hx_pos_1146cbfc6764fb25_367_updateMap)
HXLINE( 369)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 370)			this->_debugRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,this->_tileWidth,this->_tileHeight);
            		}
...
void FlxTilemap_obj::drawDebugOnCamera( ::flixel::FlxCamera Camera){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_380_drawDebugOnCamera)
HXLINE( 381)		if (!(::flixel::FlxG_obj::renderTile)) {
HXLINE( 382)			return;
            		}
HXLINE( 384)		 ::flixel::tile::FlxTilemapBuffer buffer = null();
HXLINE( 385)		int l = ::flixel::FlxG_obj::cameras->list->length;
HXLINE( 387)		{
HXLINE( 387)			int _g = 0;
HXDLIN( 387)			int _g1 = l;
HXDLIN( 387)			while((_g < _g1)){
HXLINE( 387)				_g = (_g + 1);
HXDLIN( 387)				int i = (_g - 1);
HXLINE( 389)				if (::hx::IsEq( ::flixel::FlxG_obj::cameras->list->__get(i).StaticCast<  ::flixel::FlxCamera >(),Camera )) {
HXLINE( 391)					buffer = this->_buffers->__get(i).StaticCast<  ::flixel::tile::FlxTilemapBuffer >();
HXLINE( 392)					goto _hx_goto_15;
            				}
            			}
            			_hx_goto_15:;
            		}
HXLINE( 396)		if (::hx::IsNull( buffer )) {
HXLINE( 397)			return;
            		}
HXLINE( 400)		this->_helperPoint->x = (this->x - (Camera->scroll->x * this->scrollFactor->x));
HXLINE( 401)		this->_helperPoint->y = (this->y - (Camera->scroll->y * this->scrollFactor->y));
HXLINE( 403)		Float rectWidth = this->_scaledTileWidth;
HXLINE( 404)		Float rectHeight = this->_scaledTileHeight;
HXLINE( 405)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 405)		_this->x = ( (Float)(0) );
HXDLIN( 405)		_this->y = ( (Float)(0) );
HXDLIN( 405)		_this->width = rectWidth;
HXDLIN( 405)		_this->height = rectHeight;
HXDLIN( 405)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 405)		rect->_inPool = false;
HXDLIN( 405)		 ::flixel::math::FlxRect rect1 = rect;
HXLINE( 409)		this->_point->set_x(((Camera->scroll->x * this->scrollFactor->x) - this->x));
HXLINE( 410)		this->_point->set_y(((Camera->scroll->y * this->scrollFactor->y) - this->y));
HXLINE( 411)		int screenXInTiles = ::Math_obj::floor((this->_point->x / this->_scaledTileWidth));
HXLINE( 412)		int screenYInTiles = ::Math_obj::floor((this->_point->y / this->_scaledTileHeight));
HXLINE( 413)		int screenRows = buffer->rows;
HXLINE( 414)		int screenColumns = buffer->columns;
HXLINE( 417)		 ::Dynamic Max = (this->widthInTiles - screenColumns);
HXDLIN( 417)		Float lowerBound;
HXDLIN( 417)		if ((screenXInTiles < 0)) {
HXLINE( 417)			lowerBound = ( (Float)(0) );
            		}
            		else {
HXLINE( 417)			lowerBound = ( (Float)(screenXInTiles) );
            		}
HXDLIN( 417)		Float screenXInTiles1;
HXDLIN( 417)		bool screenXInTiles2;
HXDLIN( 417)		if (::hx::IsNotNull( Max )) {
HXLINE( 417)			screenXInTiles2 = ::hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE( 417)			screenXInTiles2 = false;
            		}
HXDLIN( 417)		if (screenXInTiles2) {
HXLINE( 417)			screenXInTiles1 = ( (Float)(Max) );
            		}
            		else {
HXLINE( 417)			screenXInTiles1 = lowerBound;
            		}
HXDLIN( 417)		screenXInTiles = ::Std_obj::_hx_int(screenXInTiles1);
HXLINE( 418)		 ::Dynamic Max1 = (this->heightInTiles - screenRows);
HXDLIN( 418)		Float lowerBound1;
HXDLIN( 418)		if ((screenYInTiles < 0)) {
HXLINE( 418)			lowerBound1 = ( (Float)(0) );
            		}
            		else {
HXLINE( 418)			lowerBound1 = ( (Float)(screenYInTiles) );
            		}
HXDLIN( 418)		Float screenYInTiles1;
HXDLIN( 418)		bool screenYInTiles2;
HXDLIN( 418)		if (::hx::IsNotNull( Max1 )) {
HXLINE( 418)			screenYInTiles2 = ::hx::IsGreater( lowerBound1,Max1 );
            		}
            		else {
HXLINE( 418)			screenYInTiles2 = false;
            		}
HXDLIN( 418)		if (screenYInTiles2) {
HXLINE( 418)			screenYInTiles1 = ( (Float)(Max1) );
            		}
            		else {
HXLINE( 418)			screenYInTiles1 = lowerBound1;
            		}
HXDLIN( 418)		screenYInTiles = ::Std_obj::_hx_int(screenYInTiles1);
HXLINE( 420)		int rowIndex = ((screenYInTiles * this->widthInTiles) + screenXInTiles);
HXLINE( 421)		int columnIndex;
HXLINE( 422)		 ::flixel::tile::FlxTile tile;
HXLINE( 424)		{
HXLINE( 424)			int _g2 = 0;
HXDLIN( 424)			int _g3 = screenRows;
HXDLIN( 424)			while((_g2 < _g3)){
HXLINE( 424)				_g2 = (_g2 + 1);
HXDLIN( 424)				int row = (_g2 - 1);
HXLINE( 426)				columnIndex = rowIndex;
HXLINE( 428)				{
HXLINE( 428)					int _g = 0;
HXDLIN( 428)					int _g1 = screenColumns;
HXDLIN( 428)					while((_g < _g1)){
HXLINE( 428)						_g = (_g + 1);
HXDLIN( 428)						int column = (_g - 1);
HXLINE( 430)						tile = Dynamic( this->_tileObjects->__get(this->_data->__get(columnIndex))).StaticCast<  ::flixel::tile::FlxTile >();
HXLINE( 432)						bool _hx_tmp;
HXDLIN( 432)						if (::hx::IsNotNull( tile )) {
HXLINE( 432)							_hx_tmp = tile->visible;
            						}
            						else {
HXLINE( 432)							_hx_tmp = false;
            						}
HXDLIN( 432)						if (_hx_tmp) {
HXLINE( 434)							rect1->x = (this->_helperPoint->x + (( (Float)(::hx::Mod(columnIndex,this->widthInTiles)) ) * rectWidth));
HXLINE( 435)							rect1->y = (this->_helperPoint->y + (( (Float)(::Math_obj::floor((( (Float)(columnIndex) ) / ( (Float)(this->widthInTiles) )))) ) * rectHeight));
HXLINE( 436)							 ::openfl::display::Graphics _hx_tmp = Camera->debugLayer->get_graphics();
HXDLIN( 436)							this->drawDebugBoundingBox(_hx_tmp,rect1,tile->allowCollisions,(tile->allowCollisions != 4369));
            						}
HXLINE( 439)						columnIndex = (columnIndex + 1);
            					}
            				}
HXLINE( 442)				rowIndex = (rowIndex + this->widthInTiles);
            			}
            		}
HXLINE( 445)		if (!(rect1->_inPool)) {
HXLINE( 445)			rect1->_inPool = true;
HXDLIN( 445)			rect1->_weak = false;
HXDLIN( 445)			::flixel::math::FlxRect_obj::_pool->putUnsafe(rect1);
            		}
            	}
...
HXLINE( 513)				::flixel::FlxBasic_obj::visibleCount++;
            			}
            		}
HXLINE( 518)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 519)			this->drawDebug();
            		}
            	}
...
HXLINE( 963)		 ::openfl::display::BitmapData debugTile;
HXLINE( 966)		{
HXLINE( 966)			int _g = 0;
...
HXDLIN( 984)								if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 984)									_hx_tmp = !(this->ignoreDrawDebug);
            								}
            								else {
HXLINE( 984)									_hx_tmp = false;
            								}
HXDLIN( 984)								if (_hx_tmp) {
HXLINE( 986)									if ((tile->allowCollisions <= 0)) {
HXLINE( 988)										debugTile = this->_debugTileNotSolid;
            									}
            									else {
HXLINE( 990)										if ((tile->allowCollisions != 4369)) {
HXLINE( 992)											debugTile = this->_debugTilePartial;
            										}
            										else {
HXLINE( 996)											debugTile = this->_debugTileSolid;
            										}
            									}
HXLINE( 999)									{
HXLINE( 999)										 ::flixel::math::FlxPoint _this = this->offset;
HXDLIN( 999)										 ::openfl::geom::Point FlashPoint = this->_flashPoint;
HXDLIN( 999)										 ::openfl::geom::Point FlashPoint1 = FlashPoint;
HXDLIN( 999)										FlashPoint1->x = (FlashPoint1->x + _this->x);
HXDLIN( 999)										 ::openfl::geom::Point FlashPoint2 = FlashPoint;
HXDLIN( 999)										FlashPoint2->y = (FlashPoint2->y + _this->y);
            									}
HXLINE(1000)									Buffer->pixels->copyPixels(debugTile,this->_debugRect,this->_flashPoint,null(),null(),true);
HXLINE(1001)									{
HXLINE(1001)										 ::flixel::math::FlxPoint _this1 = this->offset;
HXDLIN(1001)										 ::openfl::geom::Point FlashPoint3 = this->_flashPoint;
HXDLIN(1001)										 ::openfl::geom::Point FlashPoint4 = FlashPoint3;
HXDLIN(1001)										FlashPoint4->x = (FlashPoint4->x - _this1->x);
HXDLIN(1001)										 ::openfl::geom::Point FlashPoint5 = FlashPoint3;
HXDLIN(1001)										FlashPoint5->y = (FlashPoint5->y - _this1->y);
            									}
            								}
            							}
            							else {
...
HX_DEFINE_DYNAMIC_FUNC2(FlxTilemap_obj,drawTilemap,(void))
 ...
 ::openfl::display::BitmapData FlxTilemap_obj::makeDebugTile(int color){
            	HX_GC_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1063_makeDebugTile)
HXLINE(1064)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(1065)			return null();
            		}
HXLINE(1067)		 ::openfl::display::BitmapData debugTile =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_tileWidth,this->_tileHeight,true,0);
HXLINE(1068)		this->drawDebugTile(debugTile,color);
HXLINE(1069)		return debugTile;
            	}
...
void FlxTilemap_obj::drawDebugTile( ::openfl::display::BitmapData debugTile,int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1074_drawDebugTile)
HXDLIN(1074)		if ((color != 0)) {
HXLINE(1076)			 ::openfl::display::Graphics gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
HXLINE(1077)			gfx->clear();
HXLINE(1078)			gfx->moveTo(( (Float)(0) ),( (Float)(0) ));
HXLINE(1079)			gfx->lineStyle(1,color,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(1080)			gfx->lineTo(( (Float)((this->_tileWidth - 1)) ),( (Float)(0) ));
HXLINE(1081)			gfx->lineTo(( (Float)((this->_tileWidth - 1)) ),( (Float)((this->_tileHeight - 1)) ));
HXLINE(1082)			gfx->lineTo(( (Float)(0) ),( (Float)((this->_tileHeight - 1)) ));
HXLINE(1083)			gfx->lineTo(( (Float)(0) ),( (Float)(0) ));
HXLINE(1085)			debugTile->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
void FlxTilemap_obj::onDrawDebugChanged(){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1091_onDrawDebugChanged)
HXDLIN(1091)		this->setDirty(null());
            	}
...
int FlxTilemap_obj::set_debugBoundingBoxColorSolid(int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1250_set_debugBoundingBoxColorSolid)
HXLINE(1251)		this->super::set_debugBoundingBoxColorSolid(color);
HXLINE(1252)		this->updateDebugTileBoundingBoxSolid();
HXLINE(1253)		return color;
            	}


int FlxTilemap_obj::set_debugBoundingBoxColorNotSolid(int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1257_set_debugBoundingBoxColorNotSolid)
HXLINE(1258)		this->super::set_debugBoundingBoxColorNotSolid(color);
HXLINE(1259)		this->updateDebugTileBoundingBoxNotSolid();
HXLINE(1260)		return color;
            	}


int FlxTilemap_obj::set_debugBoundingBoxColorPartial(int color){
            	HX_STACKFRAME(&_hx_pos_1146cbfc6764fb25_1264_set_debugBoundingBoxColorPartial)
HXLINE(1265)		this->super::set_debugBoundingBoxColorPartial(color);
HXLINE(1266)		this->updateDebugTileBoundingBoxPartial();
HXLINE(1267)		return color;
            	}

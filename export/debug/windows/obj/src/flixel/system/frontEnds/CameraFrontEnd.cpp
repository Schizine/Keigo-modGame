...
HXLINE(  92)			::flixel::FlxG_obj::log->advanced(HX_("FlxG.cameras.remove(): The camera you attempted to remove is not a part of the game.",63,6f,2b,31),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(  93)			return;
            		}
...
HXLINE( 123)			::flixel::FlxG_obj::log->advanced(HX_("FlxG.cameras.setDefaultDrawTarget(): The specified camera is not a part of the game.",17,fb,50,a6),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 124)			return;
            		}
...
HXLINE( 240)				camera->debugLayer->get_graphics()->clear();
            			}

...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_198_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",198,0x1a8855ec)
...
HXLINE( 122)		switch((int)(noteData)){
            			case (int)0: {
HXLINE( 125)				{
HXLINE( 125)					 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 125)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(0) ))));
            				}
...
HXDLIN( 128)					_g->set_x((_g->x + ::Note_obj::swagWidth));
            				}
HXLINE( 129)				this->animation->play(HX_("blueScroll",47,7e,59,a2),null(),null(),null());
            			...
            			case (int)2: {
HXLINE( 131)				{
HXLINE( 131)					 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 131)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(2) ))));
            				}
...
HXDLIN( 134)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(3) ))));
            				}
...
HXDLIN( 143)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXLINE( 143)			_hx_tmp = ( (bool)(sustainNote) );
            		}
            		else {
HXLINE( 143)			_hx_tmp = false;
            		}
HXDLIN( 143)		if (_hx_tmp) {
HXLINE( 144)			this->set_flipY(true);
            		}
HXLINE( 146)		bool _hx_tmp1;
HXDLIN( 146)		if (this->isSustainNote) {
HXLINE( 146)			_hx_tmp1 = ::hx::IsNotNull( prevNote );
            		}
            		else {
...
HXLINE( 153)			switch((int)(noteData)){
            				case (int)0: {
HXLINE( 162)					this->animation->play(HX_("purpleholdend",40,d5,15,5b),null(),null(),null());
            				}
            				break;
            				case (int)1: {
HXLINE( 160)					this->animation->play(HX_("blueholdend",a2,f0,cd,25),null(),null(),null());
            				}
            				break;
            				case (int)2: {
HXLINE( 156)					this->animation->play(HX_("greenholdend",99,eb,5f,39),null(),null(),null());
            				}
            				break;
            				case (int)3: {
HXLINE( 158)					this->animation->play(HX_("redholdend",cb,ae,1e,ea),null(),null(),null());
            				}
            				break;
            			}
HXLINE( 165)			this->updateHitbox();
HXLINE( 167)			{
HXLINE( 167)				 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 167)				Float _g3 = _g2->x;
HXDLIN( 167)				_g2->set_x((_g3 - (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 169)			if (::StringTools_obj::startsWith(::PlayState_obj::curStage,HX_("school",74,b8,c8,40))) {
HXLINE( 170)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 170)				_g->set_x((_g->x + 30));
            			}
HXLINE( 172)			if (prevNote->isSustainNote) {
HXLINE( 174)				switch((int)(prevNote->noteData)){
            					case (int)0: {
HXLINE( 177)						prevNote->animation->play(HX_("purplehold",7b,8d,da,cd),null(),null(),null());
            					}
            					break;
            					case (int)1: {
HXLINE( 179)						prevNote->animation->play(HX_("bluehold",d9,60,aa,a4),null(),null(),null());
            					}
            					break;
            					case (int)2: {
HXLINE( 181)						prevNote->animation->play(HX_("greenhold",82,f5,c1,bc),null(),null(),null());
            					}
            					break;
            					case (int)3: {
HXLINE( 183)						prevNote->animation->play(HX_("redhold",10,1f,bf,bf),null(),null(),null());
            					}
            					break;
            				}
HXLINE( 187)				if (::hx::IsNotEq( ::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic),1 )) {
HXLINE( 188)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 188)					_g->set_y((_g->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.5)) * ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic)) ))));
            				}
            				else {
...
HXLINE( 191)				prevNote->updateHitbox();
            			}
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_198_update)
HXLINE( 199)		this->super::update(elapsed);
HXLINE( 201)		if (this->mustPress) {
HXLINE( 204)			if (this->isSustainNote) {
...
HXDLIN( 214)				if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 214)					_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + ::Conductor_obj::safeZoneOffset));
            				}
            				else {
HXLINE( 214)					_hx_tmp = false;
            				}
HXDLIN( 214)				if (_hx_tmp) {
HXLINE( 216)					this->canBeHit = true;
            				}
            				else {
HXLINE( 218)					this->canBeHit = false;
            				}
            			}
HXLINE( 221)			bool _hx_tmp;
HXDLIN( 221)			if ((this->strumTime < (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ::Conductor_obj::timeScale)))) {
HXLINE( 221)				_hx_tmp = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 221)				_hx_tmp = false;
            			}
HXDLIN( 221)			if (_hx_tmp) {
HXLINE( 222)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 226)			this->canBeHit = false;
HXLINE( 228)			if ((this->strumTime <= ::Conductor_obj::songPosition)) {
HXLINE( 229)				this->wasGoodHit = true;
            			}
            		}
HXLINE( 232)		if (this->tooLate) {
HXLINE( 234)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 235)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}

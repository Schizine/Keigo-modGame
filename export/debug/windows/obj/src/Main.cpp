...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_121_toggleFPS,"Main","toggleFPS",0x9eefd060,"Main.toggleFPS","Main.hx",121,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_126_changeFPSColor,"Main","changeFPSColor",0xbde8c2bf,"Main.changeFPSColor","Main.hx",126,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_131_setFPSCap,"Main","setFPSCap",0x4fb5c496,"Main.setFPSCap","Main.hx",131,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_136_getFPSCap,"Main","getFPSCap",0x6c64d88a,"Main.getFPSCap","Main.hx",136,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_141_getFPS,"Main","getFPS",0xd3c70468,"Main.getFPS","Main.hx",141,0x087e5c05)
...
HXLINE(  86)		::String ourSource = HX_("assets/videos/DO NOT DELETE OR GAME WILL CRASH/dontDelete.webm",a4,1f,1a,38);
HXLINE(  98)		::String str1 = HX_("WEBM SHIT",e7,ff,8c,40);
HXLINE(  99)		 ::WebmHandler webmHandle =  ::WebmHandler_obj::__alloc( HX_CTX );
HXLINE( 100)		webmHandle->source(ourSource);
HXLINE( 101)		webmHandle->makePlayer();
HXLINE( 102)		webmHandle->webm->set_name(str1);
HXLINE( 103)		this->addChild(webmHandle->webm);
HXLINE( 104)		::GlobalVideo_obj::setWebm(webmHandle);
HXLINE( 109)		this->fpsCounter =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE( 110)		this->addChild(this->fpsCounter);
HXLINE( 111)		this->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
            	}
...
void Main_obj::toggleFPS(bool fpsEnabled){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_121_toggleFPS)
HXDLIN( 121)		this->fpsCounter->set_visible(fpsEnabled);
            	}
...
void Main_obj::changeFPSColor(int color){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_126_changeFPSColor)
HXDLIN( 126)		this->fpsCounter->set_textColor(color);
            	}
...
void Main_obj::setFPSCap(Float cap){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_131_setFPSCap)
HXDLIN( 131)		::openfl::Lib_obj::get_current()->stage->set_frameRate(cap);
            	}
...
Float Main_obj::getFPSCap(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_136_getFPSCap)
HXDLIN( 136)		return ::openfl::Lib_obj::get_current()->stage->get_frameRate();
            	}
...
Float Main_obj::getFPS(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_141_getFPS)
HXDLIN( 141)		return ( (Float)(this->fpsCounter->currentFPS) );
            	}
